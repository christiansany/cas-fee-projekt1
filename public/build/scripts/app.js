...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _noteModel = __webpack_require__(139);
	
	var _noteModel2 = _interopRequireDefault(_noteModel);
	
	var _router = __webpack_require__(197);
	
	var _themeSwitcher = __webpack_require__(198);
	
	var _sorter = __webpack_require__(199);
	
	var _filter = __webpack_require__(200);
	
	var _noteList = __webpack_require__(201);
	...
	var filter = (0, _filter.createFilter)(document.querySelector('[data-show-finished]'));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _handlebarsSafeString = __webpack_require__(136);
	
	var _handlebarsSafeString2 = _interopRequireDefault(_handlebarsSafeString);
	
	var _handlebarsException = __webpack_require__(124);
	
	var _handlebarsException2 = _interopRequireDefault(_handlebarsException);
	
	var _handlebarsUtils = __webpack_require__(123);
	
	var Utils = _interopRequireWildcard(_handlebarsUtils);
	
	var _handlebarsRuntime = __webpack_require__(137);
	
	var runtime = _interopRequireWildcard(_handlebarsRuntime);
	
	var _handlebarsNoConflict = __webpack_require__(138);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _exception = __webpack_require__(124);
	
	var _exception2 = _interopRequireDefault(_exception);
	
	var _helpers = __webpack_require__(125);
	
	var _decorators = __webpack_require__(133);
	
	var _logger = __webpack_require__(135);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _helpersBlockHelperMissing = __webpack_require__(126);
	
	var _helpersBlockHelperMissing2 = _interopRequireDefault(_helpersBlockHelperMissing);
	
	var _helpersEach = __webpack_require__(127);
	
	var _helpersEach2 = _interopRequireDefault(_helpersEach);
	
	var _helpersHelperMissing = __webpack_require__(128);
	
	var _helpersHelperMissing2 = _interopRequireDefault(_helpersHelperMissing);
	
	var _helpersIf = __webpack_require__(129);
	
	var _helpersIf2 = _interopRequireDefault(_helpersIf);
	
	var _helpersLog = __webpack_require__(130);
	
	var _helpersLog2 = _interopRequireDefault(_helpersLog);
	
	var _helpersLookup = __webpack_require__(131);
	
	var _helpersLookup2 = _interopRequireDefault(_helpersLookup);
	
	var _helpersWith = __webpack_require__(132);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _note = __webpack_require__(196);
	...
	var NoteModel = function NoteModel() {
	    ...
	    self.addNote = function (data) {
	        ...
	        return new Promise(function (resolve) {
	            ...
	            fetch('/notes', params).then(resolve);
	        });
	    };
	    ...
	    self.updateNote = function (_id, data) {
	        ...
	        return new Promise(function (resolve) {
	            ...
	            fetch('/notes/' + note._id, params).then(resolve);
	        });
	    };
	    ...
	    self.removeNote = function (_id) {
	        ...
	        return new Promise(function (resolve) {
	            ...
	            fetch('/notes/' + _id, params).then(resolve);
	        });
	    };
	    ...
	    var noteAdded = function noteAdded(note) {
	        self.notes.push(new _note.Note(note));
	        ob.trigger('notes', self.notes, 'added');
	    };
	
	    var noteUpdated = function noteUpdated(note) {
	        self.notes[self.notes.findIndex(function (n) {
	            return n._id === note._id;
	        })] = new _note.Note(note);
	        ob.trigger('notes', self.notes, 'updated');
	    };
	
	    var noteDeleted = function noteDeleted(data) {
	    ...
	    _socket2.default.on('noteAdded', noteAdded);
	    _socket2.default.on('noteUpdated', noteUpdated);
	    _socket2.default.on('noteDeleted', noteDeleted);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _socket = __webpack_require__(142);
	
	var _socket2 = _interopRequireDefault(_socket);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	exports.default = _socket2.default.connect('http://localhost:8080');
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var debug = __webpack_require__(145)('socket.io-client');
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var debug = __webpack_require__(145)('socket.io-client:url');
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var eio = __webpack_require__(160);
	var Socket = __webpack_require__(189);
	var Emitter = __webpack_require__(190);
	var parser = __webpack_require__(149);
	var on = __webpack_require__(192);
	var bind = __webpack_require__(193);
	var debug = __webpack_require__(145)('socket.io-client:manager');
	var indexOf = __webpack_require__(187);
...
/***/ (function(module, exports, __webpack_require__) {
	 ...
	 *
	 */
	module.exports.parser = __webpack_require__(169);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var transports = __webpack_require__(163);
	...
	var parseuri = __webpack_require__(144);
	var parsejson = __webpack_require__(188);
	var parseqs = __webpack_require__(178);
	...
	Socket.Transport = __webpack_require__(168);
	Socket.transports = __webpack_require__(163);
	Socket.parser = __webpack_require__(169);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var XMLHttpRequest = __webpack_require__(164);
	var XHR = __webpack_require__(166);
	var JSONP = __webpack_require__(184);
	var websocket = __webpack_require__(185);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var hasCORS = __webpack_require__(165);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Emitter = __webpack_require__(177);
	var inherit = __webpack_require__(179);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Transport = __webpack_require__(168);
	var parseqs = __webpack_require__(178);
	var parser = __webpack_require__(169);
	var inherit = __webpack_require__(179);
	var yeast = __webpack_require__(180);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var hasBinary = __webpack_require__(171);
	var sliceBuffer = __webpack_require__(172);
	var after = __webpack_require__(173);
	var utf8 = __webpack_require__(174);
	
	var base64encoder;
	if (global && global.ArrayBuffer) {
	  base64encoder = __webpack_require__(175);
	}
	...
	var Blob = __webpack_require__(176);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	;(function (root) {
		...
		// like the following:
		if ("function" == 'function' && _typeof(__webpack_require__(154)) == 'object' && __webpack_require__(154)) {
			!(__WEBPACK_AMD_DEFINE_RESULT__ = function () {
				return wtf8;
			}.call(exports, __webpack_require__, exports, module), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (typeof window === 'undefined') {
	  try {
	    NodeWebSocket = __webpack_require__(186);
	  } catch (e) {}
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var on = __webpack_require__(192);
	var bind = __webpack_require__(193);
	var debug = __webpack_require__(145)('socket.io-client:socket');
	var hasBin = __webpack_require__(194);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Note = exports.Note = function Note(obj) {
	    ...
	    Object.defineProperty(this, 'dueDate', {
	        ...
	        set: function set(val) {
	            if (val instanceof _moment2.default) this._dueDate = val;else this._dueDate = new _moment2.default(val, 'DD.MM.YYYY');
	        }
	    });
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var createFilter = exports.createFilter = function createFilter(trigger) {
	    ...
	    instance.showFinished = function () {
	        return state.showFinished;
	    };
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _pikaday = __webpack_require__(204);
	...
	(function (root, factory) {
	    ...
	    if (( false ? 'undefined' : _typeof(exports)) === 'object') {
	        ...
	        !(__WEBPACK_AMD_DEFINE_RESULT__ = function (req) {
	            ...
	            var id = 'moment';
	            try {
	                moment = __webpack_require__(205)(id);
	            } catch (e) {}
